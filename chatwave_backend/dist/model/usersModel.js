...
class usersModel {
    constructor() {
        ...
        this.register = (name, email, password, phone, position, photo, fn) => __awaiter(this, void 0, void 0, function* () {
            this.mongo.connect();
            yield this.mongo.model.create({ 'name': name, 'email': email, 'password': this.cryptPassword(password), 'phone': phone, 'position': position, 'photo': photo })
                .then(() => {
                fn(1);
            })
                .catch((error) => {
