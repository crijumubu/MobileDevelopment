...
import 'package:login/Resources/Controllers/Auth_controller.dart';
import 'package:login/Resources/Views/Menu.dart';
...
class _AppState extends State<App>{
  ...
  void checkToken() async{
    ...
    if (token != null){
      ...
      final validation = await authController.checkToken(token);
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async{
                              ...
                              if (_formKey.currentState!.validate()) {
                                ...
                                await authController.loginUser(_email.text, _password.text);
                                Navigator.push(context, MaterialPageRoute(builder: (context) => Menu()));
                              }
                            },
